...
class _ServicesPageState extends State<ServicesPage> {
  ...
  void listresult(bool btnClick) {
    ...
    return setState(() {
      if (btnClick == true) {
        searchResult = IpabResultCard(
          urlBenchName: _chosenbenchValue,
          urlServiceName: widget.data.title,
          urlCategoryName: _chosenCauseListCatValue,
          resultFontColor: widget.data.servicecolor,
        );
      }
    });
  }
